...
<head>
    ...
    <title>Expense Management - Log in form</title>
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">
                                    ...
                                    <h4 class="text-center">Sistema de Controle Financeiro</h4>
                                ...
                                <p class="mt-5 login-form__footer">Ainda não tem conta?<a href="signup.php" class="text-primary">Cadastre-se</a> agora</p>
                            </div>
                        </div>
                    </div>
                </div>
