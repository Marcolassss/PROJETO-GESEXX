...
//condicionais mensagem erros
                if( empty($_POST["expense_date"]) ){
                    $dateErr = "<P style='color:red'>* Adicione uma data de despesa </p>";
               }else {
                   $date = trim($_POST["expense_date"]);
               }

               if( empty($_POST["item"]) ){
                $itemErr = "<P style='color:red'>* Adicione um nome ao item </p>";
              }else {
              ...
              if( empty($_POST["expense_price"]) ){
                $priceErr = "<P style='color:red'>* Adicione o preço do item </p>";
              }else {
               $price = trim($_POST["expense_price"]);
                ...
                if ( !empty($date) && !empty($item) && !empty($price) ){
                        ...
                        Item adicionado a lista de despesas !
               ...
               <div class="form-input-content m-5">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">
                                    <h4 class="text-center">Adicionar Despesa </h4>
                                ...
                                <div class="form-group">
                                    <input type="submit" value="Adicionar" class="btn login-form__btn submit w-10 " name="submit_expense" >
                                </div>
